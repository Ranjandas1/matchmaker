...
export function ClientDetails({
  ...
  const [activeTab, setActiveTab] = useState<"biodata" | "matches" | "notes">(
    "biodata",
  );
  ...
  const [selectedMatch, setSelectedMatch] = useState<SuggestedMatch | null>(
    null,
  );
  ...
  const handleRequestAiAnalysis = async (match: SuggestedMatch) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(
          `AI Compatibility analysis loaded for ${match.profile.firstName}`,
        );
      } else {
  ...
  const handleSendMatchProposal = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStage("Intro Sent");
        toast.success(
          `Match invitation sent to ${selectedMatch.profile.firstName}! Journey stage updated.`,
        );
        ...
        {activeTab === "biodata" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card text-card-foreground border border-border rounded-2xl p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-foreground font-light">
                      {client.dob} ({client.age} years old)
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">
              ...
              <div className="bg-card text-card-foreground border border-border rounded-2xl p-6 shadow-sm">
                <h3 className="text-base font-bold text-foreground mb-5 flex items-center gap-2 border-b border-border/80 pb-3">
                  <Briefcase className="w-4.5 h-4.5 text-primary" /> Education &
                  Career
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                  <div className="flex flex-col gap-0.5">
              ...
              <div className="bg-card text-card-foreground border border-border rounded-2xl p-6 shadow-sm">
                <h3 className="text-base font-bold text-foreground mb-5 flex items-center gap-2 border-b border-border/80 pb-3">
                  <Languages className="w-4.5 h-4.5 text-primary" /> Cultural
                  Background
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                  <div className="flex flex-col gap-0.5">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card text-card-foreground border border-border rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-3.5 text-sm">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-foreground font-light select-all">
                      {client.email}
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
              ...
              <div className="bg-card text-card-foreground border border-border rounded-2xl p-6 shadow-sm">
                <h3 className="text-base font-bold text-foreground mb-5 flex items-center gap-2 border-b border-border/80 pb-3">
                  <Flame className="w-4.5 h-4.5 text-primary" /> Lifestyle &
                  Lifestyle Preferences
                </h3>
                <div className="space-y-3.5 text-sm">
                  <div className="flex flex-col gap-0.5">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-foreground font-light">
                      {client.familyType} Setup • {client.familyValues} Values
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2 pt-2 border-t border-border">
                    <div className="text-center bg-muted/40 p-2 rounded-xl border border-border">
                      <span className="block text-[8px] text-muted-foreground uppercase font-bold">
                        Kids?
                      </span>
          ...
          <div className="space-y-5">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">
                Scored Match Suggestions
              </h2>
              <p className="text-xs text-muted-foreground font-light mt-0.5">
                Evaluated against opposite-gender profiles in the pool. Strictly
                matching parameters prioritized first.
              </p>
            </div>
            ...
            <div className="space-y-5">
              {matches.map((match) => {
                ...
                if (score >= 85) {
                  ...
                  badgeText = "High Potential Match";
                } else if (score >= 70) {
                  badgeColor =
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/80 pb-4 mb-4">
                      ...
                      <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-2">
                        <div className="flex items-center gap-2">
                          <span
                            className={`text-[9px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-lg ${badgeColor}`}
                          >
                            {badgeText}
                          </span>
                          {match.strictMatch && (
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[8px] text-muted-foreground uppercase tracking-widest font-bold block leading-none">
                            Match
                            <br />
                            Score
                          </span>
                      ...
                      <div className="bg-muted/30 border border-border/50 rounded-xl p-3.5 text-xs space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-foreground font-medium">
                            {match.profile.degree} ({match.profile.college})
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Income:</span>
                          <span className="text-primary font-semibold">
                            ₹{match.profile.incomeLPA} LPA
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-foreground font-medium">
                            {match.profile.religion} • {match.profile.caste}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-foreground font-medium">
                            {match.profile.dietPreference} • Manglik:{" "}
                            {match.profile.manglik}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Habits:</span>
                          <span className="text-foreground font-medium">
                            Drink: {match.profile.drinkingHabits} • Smoke:{" "}
                            {match.profile.smokingHabits}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-muted/30 border border-border/50 rounded-xl p-3.5 text-[9px] space-y-2.5 justify-center flex flex-col">
                        ...
                        <div className="space-y-0.5">
                          <div className="flex justify-between text-muted-foreground font-light">
                            ...
                            <span className="font-semibold text-foreground">
                              {match.breakdown.financial}%
                            </span>
                          </div>
                          <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              className="h-full bg-amber-500 rounded-full"
                              style={{ width: `${match.breakdown.financial}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-0.5">
                          ...
                          <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${match.breakdown.values}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-0.5">
                          ...
                          <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${match.breakdown.lifestyle}%` }}
                            />
                          </div>
                        </div>
                      </div>
                          ...
                          <ul className="space-y-1">
                            {match.matchReasons
                              ...
                              .map((reason, idx) => (
                                <li
                                  key={idx}
                                  className="text-foreground font-light flex items-start gap-1 leading-tight"
                                >
                      ...
                      <div className="flex-1 text-xs text-muted-foreground">
                        {aiAnalysis[matchId] ? (
                          ...
                          <div className="flex items-center gap-1.5 text-muted-foreground pl-0.5 font-light italic">
                            <AlertCircle className="w-3.5 h-3.5 text-muted-foreground/85" />{" "}
                            Click "Request AI Review" to generate LLM-backed
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-5">
              <h2 className="text-lg font-bold text-foreground flex items-center gap-2">
                <Clock className="w-4.5 h-4.5 text-primary" /> Call &
                Interaction History
              </h2>
              ...
              {notes.length === 0 ? (
                <div className="text-center py-16 bg-muted/40 border border-dashed border-border rounded-2xl">
                  ...
                  <p className="text-muted-foreground text-sm font-light">
                    No call notes recorded yet. Add notes to track progress.
                  </p>
                </div>
              ) : (
                <div className="relative border-l border-border pl-6 ml-3 space-y-6">
                  {notes.map((note) => {
                    const isSystem = note.text.startsWith(
                      "[Match Proposal Sent]",
                    );
                    const cleanText = isSystem
                      ? note.text.replace("[Match Proposal Sent] ", "")
                      : note.text;
                    const cleanDate = new Date(note.createdAt).toLocaleString(
                      "en-US",
                      {
                        dateStyle: "medium",
                        timeStyle: "short",
                    ...
                    return (
                      <div key={note.id} className="relative">
                        {/* Timeline point */}
                        <span
                          className={`absolute -left-7.75 top-1.5 w-2.5 h-2.5 rounded-full border ${
                            isSystem
                        ...
                        <div
                          className={`rounded-xl p-4.5 text-sm bg-card border border-border ${
                            isSystem ? "bg-primary/1" : ""
                          }`}
                        >
            ...
            <div className="p-5 overflow-y-auto space-y-4 flex-1">
              <div className="bg-muted border border-border p-3.5 rounded-xl text-xs space-y-1 text-muted-foreground">
                ...
                <p>
                  ...
                  {selectedMatch.profile.lastName} (Age{" "}
                  {selectedMatch.profile.age}, {selectedMatch.profile.city})
                </p>
                <p>
                  <span className="font-semibold text-foreground">
                    Compatibility Score:
              ...
              <div className="space-y-1">
                <label className="text-[9px] text-muted-foreground uppercase tracking-wider font-bold pl-0.5">
                  Email Draft (Edit prior to sending)
                </label>
                <textarea
                  value={emailContent}
